#modified circular model utilised for display of structural layout of temporal network generated from hospital dataset
...
if __name__ == "__main__":
    ...
    if len(argv) != 2:
        print('usage: python3 fullstruc_modc_hosp.py [file name]')
        exit()
    ...
    try:
        ...
        for node, (x, y) in node_position.items():
            ...
            text(x, y+17,  node, fontsize=val*2,ha='center', va='center')
