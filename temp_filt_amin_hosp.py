#edge selection implementation on temporal layouts of hospital dataset using area minimisation node reordering 
...
if __name__ == "__main__":
    ...
    if len(argv) != 2:
        print('usage: python3 temp_filt_amin_hosp.py [file name]')
        exit()
